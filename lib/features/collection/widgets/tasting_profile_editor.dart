...
/// Vollständiger Editor für [TastingProfile].
/// Besteht aus drei WashiCard-Blöcken: Aroma, Geschmack, Mundgefühl.
/// Kein Chart-Preview — die Rohwerte werden direkt bearbeitet.
class TastingProfileEditor extends StatelessWidget {
  final TastingProfile profile;
  final ValueChanged<TastingProfile> onChanged;

  const TastingProfileEditor({
    super.key,
